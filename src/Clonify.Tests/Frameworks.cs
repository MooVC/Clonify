...
{
    public static readonly ImmutableArray<(ReferenceAssemblies Assembly, LanguageVersion Maximum, DateOnly SupportTo)> InScope =
    [
        ...
        (ReferenceAssemblies.Net.Net80, LanguageVersion.CSharp11, new DateOnly(2026, 11, 10)),
        (ReferenceAssemblies.Net.Net90, LanguageVersion.CSharp11, new DateOnly(2026, 5, 12)),
