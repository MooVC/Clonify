namespace Clonify.Semantics.INamedTypeSymbolExtensionsTests;
...
{
    [Fact]
    public void GivenClonifyAttributesWithNamedArgumentsThenPassthroughValuesAreCaptured()
    {
        // Arrange
        const string attribute = """
            namespace Clonify
            {
                ...
                internal sealed class ClonifyAttribute : Attribute
                {
        ...
        const string declarations = """
            ...
            [Clonify(Type = typeof(Inner))]
            public sealed partial class Outer
            {
            }

            [Clonify(Type = typeof(string))]
        ...
        outer.HasClonify(model, out ITypeSymbol value).ShouldBeTrue();
    ...
    public void GivenEncapsulatedTypeWithConversionsThenTheyAreCaptured()
    {
        ...
        wrapper.HasClonify(model, out ITypeSymbol value).ShouldBeTrue();
