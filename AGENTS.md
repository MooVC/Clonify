...
This repository hosts **Clonify**, a .NET source generator and analyzers solution.
...
- Production code resides in `src/Clonify`.
- Tests live in `src/Clonify.Tests` and mirror the main project layout.
